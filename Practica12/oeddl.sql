...
/*==============================================================*/
create table OE2.CATEGORIES_TAB 
(
...
comment on column OE2.COUNTRIES.COUNTRY_ID is
'Primary key of countries table.';

comment on column OE2.COUNTRIES.COUNTRY_NAME is
'Country name';

comment on column OE2.COUNTRIES.REGION_ID is
'Region ID for the country. Foreign key to region_id column in the departments table.';

/*==============================================================*/
/* Table: CUSTOMERS                                             */
/*==============================================================*/
create table OE2.CUSTOMERS 
(
...
comment on column OE2.CUSTOMERS.CUSTOMER_ID is
'Primary key column.';

comment on column OE2.CUSTOMERS.CUST_FIRST_NAME is
'NOT NULL constraint.';

comment on column OE2.CUSTOMERS.CUST_LAST_NAME is
'NOT NULL constraint.';

comment on column OE2.CUSTOMERS.CUST_ADDRESS is
'Object column of type address_typ.';

comment on column OE2.CUSTOMERS.CREDIT_LIMIT is
'Check constraint.';

comment on column OE2.CUSTOMERS.ACCOUNT_MGR_ID is
'References OE2.employees.employee_id.';

/*==============================================================*/
/* Table: INVENTORIES                                           */
/*==============================================================*/
create table OE2.INVENTORIES 
(
...
comment on column OE2.ORDERS.ORDER_ID is
'PRIMARY KEY column.';

comment on column OE2.ORDERS.ORDER_DATE is
'TIMESTAMP WITH LOCAL TIME ZONE column, NOT NULL constraint.';

comment on column OE2.ORDERS.ORDER_MODE is
'CHECK constraint.';

comment on column OE2.ORDERS.ORDER_STATUS is
...
comment on column OE2.ORDERS.ORDER_TOTAL is
'CHECK constraint.';

comment on column OE2.ORDERS.SALES_REP_ID is
'References OE2.employees.employee_id.';

comment on column OE2.ORDERS.PROMOTION_ID is
'Sales promotion ID. Used in SH schema';

/*==============================================================*/
/* Index: ORD_CUSTOMER_IX                                       */
/*==============================================================*/
create index OE2.ORD_CUSTOMER_IX on OE2.ORDERS (
   CUSTOMER_ID ASC
);
...
comment on column OE2.ORDER_ITEMS.ORDER_ID is
'Part of concatenated primary key, references orders.order_id.';

comment on column OE2.ORDER_ITEMS.LINE_ITEM_ID is
'Part of concatenated primary key.';

comment on column OE2.ORDER_ITEMS.PRODUCT_ID is
'References product_information.product_id.';

/*==============================================================*/
/* Index: ITEM_ORDER_IX                                         */
/*==============================================================*/
create index OE2.ITEM_ORDER_IX on OE2.ORDER_ITEMS (
   ORDER_ID ASC
);
...
/*==============================================================*/
create index OE2.ITEM_PRODUCT_IX on OE2.ORDER_ITEMS (
   PRODUCT_ID ASC
);
...
/*==============================================================*/
create table OE2.PRODUCT_DESCRIPTIONS 
(
   PRODUCT_ID           NUMBER(6)            not null,
...
comment on column OE2.PRODUCT_DESCRIPTIONS.PRODUCT_ID is
'Primary key column.';

comment on column OE2.PRODUCT_DESCRIPTIONS.LANGUAGE_ID is
'Primary key column.';

/*==============================================================*/
/* Table: PRODUCT_INFORMATION                                   */
/*==============================================================*/
create table OE2.PRODUCT_INFORMATION 
(
   PRODUCT_ID           NUMBER(6)            not null,
...
comment on column OE2.PRODUCT_INFORMATION.PRODUCT_ID is
'Primary key column.';

comment on column OE2.PRODUCT_INFORMATION.PRODUCT_DESCRIPTION is
'Primary language description corresponding to translated_description in
OE2.product_descriptions, added to provide non-NLS text columns for OC views
to accss.';

comment on column OE2.PRODUCT_INFORMATION.CATEGORY_ID is
'Low cardinality column, can be used for bitmap index.
Schema SH uses it as foreign key';

comment on column OE2.PRODUCT_INFORMATION.WEIGHT_CLASS is
'Low cardinality column, can be used for bitmap index.';

comment on column OE2.PRODUCT_INFORMATION.WARRANTY_PERIOD is
'INTERVAL YEAER TO MONTH column, low cardinality, can be used for bitmap
index.';

comment on column OE2.PRODUCT_INFORMATION.SUPPLIER_ID is
'Offers possibility of extensions outside Common Schema.';

comment on column OE2.PRODUCT_INFORMATION.PRODUCT_STATUS is
...
alter table OE2.PRODUCT_DESCRIPTIONS
   add constraint PD_PRODUCT_ID_FK foreign key (PRODUCT_ID)
      references OE2.PRODUCT_INFORMATION (PRODUCT_ID)
      not deferrable;

alter table OE2.PRODUCT_INFORMATION
   add constraint FK_PRODUCT__REFERENCE_CATEGORI foreign key (CATEGORY_ID)
      references OE2.CATEGORIES_TAB (CATEGORY_ID);

alter table OE2.WAREHOUSES
